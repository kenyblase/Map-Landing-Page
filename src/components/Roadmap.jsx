    ...
    <div className="bg-white border-gray-200 mb-8">
      ...
      <div className="flex items-center justify-between border p-6 rounded-lg">
        ...
        <div className="flex items-center">
          <div className="w-10 h-10 bg-blue-500 text-white flex items-center justify-center rounded-full text-lg font-medium">
            1
          </div>
          <div className="ml-2">
        ...
        {/* Step 2 */}
        <div className="flex items-center">
          <div className="w-10 h-10 bg-white text-gray-400 flex items-center justify-center rounded-full text-lg font-medium border">
            2
          </div>
          <div className="ml-2">
            <p className="font-medium text-gray-400">Terms and Attachments</p>
            <p className="text-sm text-gray-300">Payment and delivery terms</p>
          </div>
        </div>
